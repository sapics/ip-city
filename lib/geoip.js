...
for(var countryCode in countryJson){
	var country = countryJson[countryCode];
	country.country_code = countryCode;
	if(country.continent && continentJson[country.continent]){
		country.continent_name = continentJson[country.continent];
	}
	if(country.name){
	...
	if(country.native){
		country.country_native_name = country.native;
		delete country.native;
	}
}
continentJson = null;
